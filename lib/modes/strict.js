...
module.exports = {
  inflate: {
    ...
    DBRef: function(v) {
      ...
      && module.exports.inflate[v.oid.constructor.name] ? module.exports.inflate[v.oid.constructor.name](v.oid)
        : v.oid;
      return {
        $ref: v.namespace,
        $id: id
  ...
  deflate: {
    ...
    $ref: function(val) {
      ...
      && module.exports.deflate[Object.keys(val.$id)[0]] ? module.exports.deflate[Object.keys(val.$id)[0]](val.$id)
        : val.$id;
