...
module.exports.deflate = function() {
   /* eslint no-console:0 */
   console.warn('EJSON.deflate() has been deprecated in favor of EJSON.deserialize() '
 ...
 module.exports.inflate = function() {
   /* eslint no-console:0 */
   console.warn('EJSON.inflate() has been deprecated in favor of EJSON.serialize() '
     + 'and will be removed in the 2.x release.');
